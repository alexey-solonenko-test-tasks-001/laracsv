...
/***/ "./resources/js/deals_log_viewer.js":
/*!******************************************!*\
  !*** ./resources/js/deals_log_viewer.js ***!
  \******************************************/
/*! no exports provided */
...
$(function () {
  ...
  var landingUrl = new URL(location);
  var landingParams = qs.parse(landingUrl.search.replace(/^\?/, ''));
...
dealsLogViewer.fn.initReloadTableBtn = function () {
  dealsLogViewer.el.reloadTableBtns.forEach(function (b) {
...
dealsLogViewer.fn.initializeDealsLogTable = function () {
  ...
  if (window.searchDealLogsParams) {
    var _window$searchDealLog = window.searchDealLogsParams,
        start = _window$searchDealLog.start,
        length = _window$searchDealLog.length,
        order = _window$searchDealLog.order;
  ...
  dealsLogViewer.el.jDealLogsTable.on('xhr.dt', function (ev, settings, json, xhr) {
    ...
    var visibleRows = Array.from(dealsLogViewer.el.dDealLogsTable.rows({
      page: 'curren'
    })[0]);
  ...
  dealsLogViewer.el.logsForm.addEventListener('keydown', function (ev) {
    if (ev.key == 'Enter') {
      ev.preventDefault;
      dealsLogViewer.el.dDealLogsTable.ajax.reload(null, false);
    }
...
dealsLogViewer.fn.dealLogsData = function (req) {
  var f = new FormData(dealsLogViewer.el.logsForm);

  var _iterator = _createForOfIteratorHelper(f.entries()),
      _step;
...
dealsLogViewer.fn.initDealLogsFromLandingParams = function () {
  var _window$searchDealLog2 = window.searchDealLogsParams,
      by_client = _window$searchDealLog2.by_client,
      by_deal = _window$searchDealLog2.by_deal,
      deal = _window$searchDealLog2.deal,
      group_by = _window$searchDealLog2.group_by,
      client = _window$searchDealLog2.client,
      from = _window$searchDealLog2.from,
      to = _window$searchDealLog2.to;
  [{
    by_client: by_client
  }, {
    by_deal: by_deal
    ...
    var el = dealsLogViewer.el.logsForm.querySelector('*[name="' + Object.keys(param)[0] + '"]');
    if (!el) return;
    var val = Object.values(param)[0];
...
dealsLogViewer.fn.initCopyLinkBtn = function () {
  dealsLogViewer.el.copyLinkBtn.addEventListener('click', /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 6:
              ...
              _context.prev = 8;
              _context.next = 11;
              return navigator.clipboard.writeText(window.lastDealLogsUrl);
...
/***/ 0:
/*!**************************************************************************!*\
  !*** multi ./resources/js/deals_log_viewer.js ./resources/sass/app.scss ***!
  \**************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! C:\code\laracsv\resources\js\deals_log_viewer.js */"./resources/js/deals_log_viewer.js");
